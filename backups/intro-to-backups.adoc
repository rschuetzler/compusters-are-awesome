...
Many sync services provide the ability to "undelete" files for a certain period of time (a few days or up to 30, depending on the service).
As long as you notice the files missing in time, you may be able to recover them.

[TIP]
Sync and online backup services only work when the computer is connected to the Internet. If you make changes to a file while not connected, it will be backed up once the computer connects again.
...
. Why is it important to have more than one backup copy?
